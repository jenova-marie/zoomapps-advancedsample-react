...
module.exports = {
  ...
  setResponseHeaders(req, res, next) {
    ...
    res.setHeader(
      ...
      `default-src *; style-src 'self' 'unsafe-inline'; script-src * 'self' https://appssdk.zoom.us 'unsafe-inline'; connect-src * 'self' wss://${host}/sockjs-node wss://${host}; img-src 'self' data: https://images.unsplash.com; worker-src 'self' blob:; base-uri 'self'; form-action 'self';`
    )
